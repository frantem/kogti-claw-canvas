      ...
      <div className="absolute bottom-0 left-0 right-0 p-3 md:p-6 text-white">
        ...
        {master.booking_link && getWidgetId() && (
          <DikidiButton 
            ...
            className="flex items-center justify-center w-full mx-auto bg-white text-black hover:bg-white/90 font-semibold py-0.5 md:py-1 rounded-full text-xs md:text-base transition-all duration-300"
          />
        )}
      </div>
    </Card>;
